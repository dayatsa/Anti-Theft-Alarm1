...
void Init_PWM0(void)
{
	PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, 50,  3); 
	PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), (1UL));
	PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), (1UL));
}

void Servo_Turn(uint8_t pos)
{
	PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, 50, pos);
...
int main(void)
{
	...
	Init_Buzzer();
	clear_LCD();
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 0x00000001, 0x0UL); 
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)), 0x00001000, 0x1UL); 
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 0x00000002, 0x0UL); 
 	...
 	while(1) 
  {
		i=ScanKey();
		switch(i) {
			case 1 : (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((12)<<2))))=0; break;
			case 2 : (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((13)<<2))))=0; break;
			case 3 : (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((14)<<2))))=0; break;
			case 4 : (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((15)<<2))))=0; break;
			default: (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((12)<<2))))=1; (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((13)<<2))))=1; (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((14)<<2))))=1; (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((15)<<2))))=1; break;
		}	
		Display_7seg(i);
		CLK_SysTickDelay(100000);
	}
  ...
  print_Line(3, "32KB  SRAM      ");	
	...
	while(1) {
      if ((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((0)<<2))))==1) printf("PIR detected!\n");
	...
	while(1)
	{
		if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((0)<<2)))) == 1) 
		{
			detek = 1;
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((12)<<2)))) 	= 0;  			
			...
			for(timer=30; timer>=0; i--)
			{
				...
				if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((1)<<2)))) == 1)
				{
					detek = 1;
					break;
				}
		...
		if(detek == 1) 
		{
			...
			{
				Buzz(10);
				if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((15)<<2)))) == 0) 
				{
					detek = 0;
					(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((12)<<2))))		= 1; 				
					break;
